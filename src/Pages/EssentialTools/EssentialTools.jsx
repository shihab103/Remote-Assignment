...
export default function EssentialTools() {
  const cards = [
    { id: 1, title: "Payments", description: "Responsibly sourced and eco-friendly fabrics for a better tomorrow.", imageUrl: img1 },
    { id: 2, title: "Analytics", description: "Understand your growth with smart, built-in analytics.", imageUrl: img2 },
    { id: 3, title: "Newsletters", description: "Build your audience with engaging, branded newsletter.", imageUrl: img3 },
    { id: 4, title: "Pages", description: "Showcase your expertise with a personal profile that sells for you.", imageUrl: img4 },
    { id: 5, title: "Contact", description: "Organize your contacts and turn them into your most valuable asset.", imageUrl: img5 },
    { id: 6, title: "Emails", description: "Showcase your expertise with a personal profile that sells for you.", imageUrl: img6 },
    { id: 7, title: "Co-sell network", description: "Collaborate with others to sell more without ad spend or extra effort.", imageUrl: img7 },
    { id: 8, title: "Enterprise plan", description: "Full white-label platform hosted on a dedicated, auto-scaling server. Includes branding freedom, private content protection, and 24/7 service availability.", imageUrl: img8 },
  ];
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className={`text-base opacity-80 mb-6 ${isLastCard ? "opacity-90" : ""}`}>
                    {card.description}
                  </p>
                </div>
                <a
